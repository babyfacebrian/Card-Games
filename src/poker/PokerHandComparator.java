...
public class PokerHandComparator implements Comparator<Hand> {
    ...
    public int compare(final Hand hand, final Hand otherHand) {
        final int classificationCompare = compareHandClassifications(hand, otherHand);
    ...
    private static int comparePairHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareTwoPairHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareSetHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareWheelHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareStraightHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareFlushHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareFullHouseHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareQuadsHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareStraightFlushWheelHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareStraightFlushHands(final Hand hand, final Hand otherHand) {
    ...
    private static int compareRoyalFlushHands(final Hand hand, final Hand otherHand) {
